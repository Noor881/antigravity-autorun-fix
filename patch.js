 ...
 *   node patch.js --path <dir> - Specify Antigravity install directory
 *
 * Author: Noor (noor811) — github.com/Noor881/antigravity-autorun-fix
 * License: MIT
 */
...
function main() {
    ...
    console.log('║  github.com/Noor881/antigravity-autorun-fix      ║');
    console.log('╚══════════════════════════════════════════════════╝');
    ...
    if (!basePath) {
        ...
        console.log('');
        console.log('   Try:');
        console.log('     node patch.js --path "C:\\Path\\To\\Antigravity"');
        process.exit(1);
    }
